...
#metadata.update_column(column_name='target_id', sdtype='id')
metadata.update_column(column_name='source_id', sdtype='categorical')
metadata.update_column(column_name='target_id', sdtype='categorical')
...
result_df.to_excel("./working/evaluation_results_default.xlsx")
print(result_df)